...
import 'package:shopping/features/onboarding_screend.dart';
...
class _SplashScreenState extends State<SplashScreen> {
  ...
  void initState() {
    super.initState();
    // Chỉ điều hướng 1 lần sau 2.5s → Onboarding
    _navTimer = Timer(const Duration(milliseconds: 2500), () {
      if (!mounted) return;
      Get.off(() => const OnboardingScreend());
    });
  }
...
class GridPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (double i = 0.0; i < size.height; i += spacing) {
